...
unit_prices = [
    (301, 103, 201, date(2024,4,1), 2800),
    (302, 104, 204, date(2024,4,1), 2800),
    (303, 101, 202, date(2024,4,1), 3000),
    (304, 102, 207, date(2024,4,1), 3300),
    (305, 105, 206, date(2024,5,1), 3000),
    (306, 106, 205, date(2024,5,1), 2500),
    (307, 107, 205, date(2024,5,1), 2500),
    (308, 108, 201, date(2024,6,1), 2200),
    (309, 109, 201, date(2024,6,1), 2200),
    (310, 110, 201, date(2024,6,1), 2200),
    (311, 110, 204, date(2024,6,2), 2800),
]
